...
data_rna = sim('ggblocks_rna_2', nside=36, nzprob_nsp=0.2, bkg_mean=.2, zi_prob=.5, Jmix=1000, seed=12)
data_pro = sim('ggblocks_pro_2', nside=36, nzprob_nsp=0.25, bkg_mean=.4, Jmix=100, seed=14)
