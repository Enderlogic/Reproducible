...
data_rna = sim('ggblocks_rna_3', nside=36, nzprob_nsp=0.2, bkg_mean=.2, zi_prob=.5, Jmix=1000, seed=12)
data_pro = sim('ggblocks_pro_3', nside=36, nzprob_nsp=0.25, bkg_mean=.4, Jmix=100, seed=14)
...
data_pro = anndata.AnnData(data_pro.X[location_pro_reordered.idx])
data_pro.obsm['spatial'] = data_rna.obsm['spatial']
...
data_rna.obs['cluster'] = data_gt.obs['cluster'][location_pro_reordered.idx]
data_pro.obs['cluster'] = data_gt.obs['cluster'][location_pro_reordered.idx]
