...
import pandas as pd
import sys
sys.path.append('/home/makx/Reproducible-main/Methods')
from spaMultiVAE.SVGP import SVGP
from spaMultiVAE.I_PID import PIDControl
from spaMultiVAE.VAE_utils import *
...
#            gene_group2_where_zero = np.quantile(raw_gene_counts[group2_idx], q=0.95, axis=0) == 0
    ...
    def train_model(self, pos, gene_ncounts, gene_raw_counts, gene_size_factors, protein_ncounts, protein_raw_counts, 
            lr=0.001, weight_decay=0.001, batch_size=512, num_samples=1, train_size=0.95, maxiter=200, patience=200, 
