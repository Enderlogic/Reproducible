...
def dci(factors, codes, continuous_factors=True, model='lasso'):
    ...
    print("Step 1: Training regressors for each factor...")
    for f in tqdm(range(nb_factors), total=nb_factors):
    ...
    print("\nStep 2: Calculating disentanglement scores...")
    for c in tqdm(range(nb_codes), total=nb_codes):
    ...
    print("\nStep 3: Calculating completeness scores...")
    for f in tqdm(range(nb_factors), total=nb_factors):
    # for f in range(nb_factors):
