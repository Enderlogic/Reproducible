...
for dataset in ['4_Human_Lymph_Node', '5_Mouse_Brain']:
    ...
    if dataset == '4_Human_Lymph_Node':
        save_dir = 'save_model/' + dataset + '/'
        model_dir_1 = os.path.join(save_dir, "model_omics1")
        # if os.path.exists(model_dir_1):
        #    print("模型已经存在！")
        #    model_omics1 = scvi.model.SCVI.load(model_dir_1, adata=data_omics1)
        # else:
        ...
        #    model_omics1.save(model_dir_1, overwrite=True)
        model_omics1 = scvi.model.SCVI.setup_anndata(
        data_omics1,
        layer="counts",
        batch_key='sample',)
        ...
        model_dir_2 = os.path.join(save_dir, "model_omics2")
        # if os.path.exists(model_dir_2):
        #    print("模型已经存在！")
        #    model_omics2 = cc.tl.TRVAE.load(model_dir_2, data_omics2)
        # else:
        ...
        #    model_omics2.save(model_dir_2, overwrite=True)
        model_omics2 = cc.tl.TRVAE(data_omics2, condition_key=condition_key, conditions=conditions, )
        model_omics2.train(
        n_epochs=500,
        alpha_epoch_anneal=200,
        ...
        # if os.path.exists(model_dir_2):
        #    print("模型已经存在！")
        #    model_omics2 = scvi.model.SCVI.load(model_dir_2, adata=data_omics2)
        # else:
